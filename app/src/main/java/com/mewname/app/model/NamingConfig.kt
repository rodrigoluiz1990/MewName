...
enum class SpecialBackgroundType(
    ...
    MEGA_EVOLUTION("SPECIAL_BACKGROUND_MEGA_EVOLUTION"),
...
enum class NamingField(val label: String) {
    ...
    EVOLVE_MARKER("Evoluir"),
    PURIFY_MARKER("Purificar"),
    SIZE("Tamanho"),
...
fun defaultSymbols() = mapOf(
    ...
    "SPECIAL_BACKGROUND_MEGA_EVOLUTION" to "\u2605M",
    ...
    "GIGANTAMAX" to "\u24BC",
    "DYNAMAX" to "\u24B9",
    "VIVILLON_ARCHIPELAGO" to "🏝️",
    "VIVILLON_CONTINENTAL" to "🌎",
    "VIVILLON_ELEGANT" to "🎀",
    "VIVILLON_FANCY" to "FAN",
    "VIVILLON_GARDEN" to "💐",
    "VIVILLON_HIGH_PLAINS" to "🧱",
    "VIVILLON_ICY_SNOW" to "❄️",
    "VIVILLON_JUNGLE" to "🐍",
    "VIVILLON_MARINE" to "⚓️",
    "VIVILLON_MEADOW" to "🌾",
    "VIVILLON_MODERN" to "🏙️",
    "VIVILLON_MONSOON" to "🌧️",
    "VIVILLON_OCEAN" to "🌊",
    "VIVILLON_POKE_BALL" to "PB",
    "VIVILLON_POLAR" to "⛄️",
    "VIVILLON_RIVER" to "💧",
    "VIVILLON_SANDSTORM" to "🌪️",
    "VIVILLON_SAVANNA" to "🦒",
    "VIVILLON_SUN" to "☀️",
    "VIVILLON_TUNDRA" to "🏔️"
)
